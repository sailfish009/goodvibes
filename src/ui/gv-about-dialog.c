...
static const gchar *translators =
	...
	"Ettore Atalan <atalanttore@googlemail.com> - German (de)\n"
	...
	"Jiri Grönroos <jiri.gronroos@iki.fi> - Finnish (fi)\n"
	...
	"Reza Almanda <rezaalmanda27@gmail.com> - Indonesian (id)\n"
	"Silvyaamalia <silvyaamalia@student.uns.ac.id> - Indonesian (id)\n"
	"Albanobattistella <albano_battistella@hotmail.com> - Italian (it)\n"
	...
	"Zbigniew Rosiek <zrosiek@gmail.com> - Polish (pl)\n"
